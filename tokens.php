...
function tokens_civicrm_tokens(&$tokens) {
  $huisartsenpraktijk = CRM_Tokens_Huisartsenpraktijk::singleton();
  $huisartsenpraktijk->tokens($tokens);
}

function tokens_civicrm_tokenValues(&$values, $cids, $job = null, $tokens = array(), $context = null) {
  $huisartsenpraktijk = CRM_Tokens_Huisartsenpraktijk::singleton();
  $huisartsenpraktijk->tokenValues($values, $cids);
}
...
function tokens_civicrm_navigationMenu(&$menu) {
  _tokens_civix_insert_navigation_menu($menu, NULL, array(
    'label' => E::ts('The Page'),
    'name' => 'the_page',
